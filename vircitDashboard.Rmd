...
# data etwork ----
links_1 <- read_csv("/Volumes/mydata/rSkilss/vircit-dachboard/data/links_gojek.csv")
nodes_1 <- read_csv("/Volumes/mydata/rSkilss/vircit-dachboard/data/nodes_gojek.csv")
